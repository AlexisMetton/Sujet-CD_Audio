...
describe('AddCD Component', () => {
  it('devrait afficher le formulaire d’ajout de CD', () => {
    mount(<AddCD onAdd={() => {}} />);
  ...
  it('devrait mettre à jour les champs du formulaire lors de la saisie', () => {
    mount(<AddCD onAdd={() => {}} />);
  ...
  it('devrait appeler onAdd après soumission du formulaire', () => {
