...
describe("cdRoutes Integration Tests with Testcontainers", () => {
    ...
    test("POST /api/cds should return 500 if insertion fails", async () => {
        // Simuler une erreur en envoyant des données invalides
        const invalidCD = { title: "New CD", artist: "New Artist", year: "invalid" };
